...
public class UserActivity {
	...
	public User loginActivity() throws IOException {
		...
		System.out.println("Sorry! You do not have the account. Request admin to get account in discussion forum");
		return null;
	}
	...
	public void deleteQuestion(UserActivity userActivity, User user) throws NumberFormatException, IOException {
		...
		if (user.getUserRole() == UserRole.ADMIN) {
			//System.out.print(user.getUsername()+"  "+question.getUser().getUsername());// the user is an admin
		...
		// Write else if condition to check if the user is a moderator
			...
			if(question.getUser().getUserRole().equals(UserRole.USER) || question.getUser().equals(user)){
			//	System.out.print(question.getUser()+" "+user);
				questionService.deleteQuestion(question);
			}
			else {
			//	System.out.print(question.getUser()+" "+user);
				System.out.println("You are not authorised to delete this question second last");
			}
		}
		else if( question.getUser().equals(user)){
		//	System.out.print(question.getUser()+" "+user);
			questionService.deleteQuestion(question);
		}
		else{
		//	System.out.print(question.getUser()+" "+user);
			System.out.println("You are not authorised to delete this questionlast ");
		}
